...
(function (document) {
	...
	MBP.fastButton = function (element, handler, pressedClass) {
		...
		this.pressedClass =
			typeof pressedClass === "undefined" ? "pressed" : pressedClass;
	...
	MBP.dodgyAndroid =
		...
		navigator.userAgent.indexOf("Android 2.3") != -1;
	...
	MBP.autogrow = function (element, lh) {
		...
		var textLineHeight = element.currentStyle
			? element.currentStyle.lineHeight
			: getComputedStyle(element, null).lineHeight;

		textLineHeight =
			textLineHeight.indexOf("px") == -1
				? setLineHeight
	...
	MBP.startupImage = function () {
		...
		if (
			navigator.platform.match(/iPhone|iPod/i) &&
			screen.height === 568 &&
			navigator.userAgent.match(/\bOS 6_/)
		) {
			if (MBP.viewportmeta) {
